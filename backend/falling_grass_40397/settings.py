"""
Django settings for falling_grass_40397 project.
...
ROOT_URLCONF = 'falling_grass_40397.urls'
...
WSGI_APPLICATION = 'falling_grass_40397.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_grass_40397 API",
    "DESCRIPTION": "API documentation for falling_grass_40397 App",
    "VERSION": "v1",
}
